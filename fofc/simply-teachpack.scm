...
Teachpack-ized by Robert Findler of Rice University, robby@cs.rice.edu, who wrote:
   ...
   (lambda (yesno)
     (cond ((and are-they? (eq? yesno #t))
	  ...
	  ((not yesno)
	   ...
	   (set! internal-<= #%<=) (set! internal-= #%=) (set! internal-> #%>)
	   (set! internal->= #%>=) (set! internal-abs #%abs) (set! 
internal-acos #%acos)
	   ...
	   (set! internal-log #%log) (set! internal-max #%max) (set! 
internal-min #%min)
	   (set! internal-modulo #%modulo) (set! internal-odd? #%odd?)
	   (set! internal-quotient #%quotient) (set! internal-random #%random)
	   (set! internal-remainder #%remainder) (set! internal-round 
orig-round)
	   (set! internal-sin #%sin) (set! internal-sqrt #%sqrt) 
(set! internal-tan #%tan)
	   (set! internal-truncate #%truncate) (set! internal-zero? #%zero?)
	   (set! internal-positive? #%positive?) (set! 
internal-negative? #%negative?)
	   (set! internal-number? #%number?) (set! 
internal-vector-ref #%vector-ref)
